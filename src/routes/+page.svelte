...
<div class="home">
	...
	<div class="menu hidden sm:block h-fit">
		...
		<section class="box max-w-screen-md fs-300 flex items-center">
			<p class="links">
				<!-- icon -->
				<svg xmlns="http://www.w3.org/2000/svg" width="50" height="52" fill="currentColor" class="bi bi-people" viewBox="0 0 16 16">
			...
			<p class="links">
				<svg xmlns="http://www.w3.org/2000/svg" width="50" height="52" fill="currentColor" class="bi bi-receipt-cutoff" viewBox="0 0 16 16">
			...
			<p class="links">
				<svg xmlns="http://www.w3.org/2000/svg" width="50" height="52" fill="currentColor" class="bi bi-pin-map" viewBox="0 0 16 16">
